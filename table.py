...
class Make:
    ...
    def headers(cols, labels):
        ...
        for label in labels:
            ...
            header_lay = widgets.Layout(width="80px", margin="0 10px 10px 0")
    ...
    def df(rows, labels, types, values):
        type_map = {"integer": np.nan, "decimal": np.nan, "text": ""}
        ...
        for i in range(rows):
            ...
            for j in range(cols):
                ...
                text_widget = cell_widget(value=val, 
                                           layout=widgets.Layout(width="80px", margin="0 10px 10px 0"))
